...
function getTransformedItems(block) {
  ...
  return [...carouselItems].map((item) => {
    ...
    [...buttonContainer.querySelectorAll("a")].forEach((anchor) => {
      ...
      anchor.innerHTML = "";
      render(
        html`<span class="spectrum-Button-label"
          >${unsafeHTML(anchorInnerHtml)}</span
        >`,
        anchor
      );
    });
  ...
  const template = html`
    <div class="action action-previous">
      ...
      >
        ...
        >
          <path
            d="M9.60475,13.84315l-6.054-5.84309L9.60719,2.1599A1.24776,1.24776,0,1,0,7.87556.363L.88232,7.1001A1.24336,1.24336,0,0,0,.88525,8.89685l6.98756,6.74256a1.24762,1.24762,0,1,0,1.73194-1.79626Z"
          ></path>
        </svg>
      </button>
    </div>
    <div class="carousel-items">
      ${innerBlocks.map((block) => unsafeHTML(block))}
    </div>
    <div class="action action-next">
      ...
      >
        ...
        >
          <path
            d="M11.5,8a1.241,1.241,0,0,0-.38556-.897L4.12768.3601A1.248,1.248,0,1,0,2.39525,2.15685L8.44952,8.00006l-6.0572,5.84053A1.24781,1.24781,0,1,0,4.125,15.63667l6.9922-6.73677A1.24515,1.24515,0,0,0,11.5,8Z"
          ></path>
        </svg>
      </button>
    </div>
